...
for year in range(2014, 2023):
    ...
    RNage_list_39 = ['RN0_9', 'RN10_19', 'RN20_29', 'RN30_39']  # 0~29세 구간
    RDage_list_39 = ['RD0_9', 'RD10_19', 'RD20_29', 'RD30_39']  # 0~29세 구간
    RNage_list_49 = ['RN40_49']  # 30~49세 구간
    RDage_list_49 = ['RD40_49']  # 30~49세 구간

    RN = [np.mean(data[RNage_list_39].sum(axis=1)), np.mean(data[RNage_list_49].sum(axis=1))]  # 0~29세와 30~49세의 평균
    RD = [np.mean(data[RDage_list_39].sum(axis=1)), np.mean(data[RDage_list_49].sum(axis=1))]  # 0~29세와 30~49세의 평균
    ...
    for t in ['0_39', '40_49', '50_59', '60_69', '70_79', '80_']:
        if t == '0_39':
            N_it = N_39
    ...
    # 첫 번째 서브플롯
    ax1 = fig.add_subplot(gs[0, 0])  # 첫 번째 열
    ax1.plot(['0_39', '40_49', '50_59', '60_69', '70_79', '80_'], RN, marker='o')  # 샘플 데이터
    ax1.set_ylabel(r'$\langle N\rangle_i$', size=20)
    ax1.set_xlabel('age', size=20)
    ax1.set_ylim(0, 0.41)
    ...
    # 두 번째 서브플롯
    ax2 = fig.add_subplot(gs[0, 1])  # 두 번째 열
    ax2.plot(['0_39', '40_49', '50_59', '60_69', '70_79', '80_'], phi, marker='o')
    ax2.set_ylabel(r'$\langle \phi\rangle_i$', size=20)
    ax2.set_xlabel('age', size=20)
    ax2.set_ylim(0, 0.25)
